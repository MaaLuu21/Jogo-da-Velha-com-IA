...
def iniciar_jogo():
    #Controla o jogo
        ...
        def vencedor(i):
                ...
                app_vencedor= Label(frame_baixo, text='Vencedor', width=18, relief='flat',pady=5, anchor='center', font=('Fixedsys 15 bold'), bg=cor1, fg=cor2)
                ...
                #Botão jogar
                b_jogar= Button(frame_baixo, command=start, text='Jogar', width=10, font=('Fixedsys 10 bold'), overrelief=RIDGE, relief='raised', bg=fundo, fg=cor0)
        ...
        def terminar():
                ...
                app_fim= Label(frame_baixo, text='Vencedor', width=18, relief='flat',pady=5, anchor='center', font=('Fixedsys 15 bold'), bg=cor1, fg=cor2)
                app_fim.place(x=25, y=200)
